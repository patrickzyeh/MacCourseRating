...
function Course(props) {
    ...
    const courseUrl = "https://courseratingbackend.vercel.app/api/";
    ...
    useEffect(() => {
        ...
        const fetchRatings = async () => {
            try {
                const response = await axios.get(courseUrl + "ratings/specific/" + courseCode);
                ...
                if (response.data.length !== 0) {
                    ...
                    setAveragePracticality(Math.round(totalPracticality / response.data.length));
                    setAverageEnjoyability(Math.round(totalEnjoyability / response.data.length));
