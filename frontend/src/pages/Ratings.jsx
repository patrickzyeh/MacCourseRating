...
function Ratings() {
    ...
    useEffect(() => {
        const fetchMostRatings = async () => {
            try {
                const response = await axios.get("https://courseratingbackend.vercel.app/api/ratings/top");
        ...
        const fetchRecentRatings = async () => {
            try {
                const response = await axios.get("https://courseratingbackend.vercel.app/api/ratings/recent");
        ...
        <div className="main-rating-page-container">
            ...
            <div className="most-rating-container">
                {mostRatings.map((ratings) => {
                    return <RatingBlocks key={ratings.course_code} courseCode={ratings.course_code} />;
                })}
            </div>
